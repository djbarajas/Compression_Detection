...
standalone : standalone.c read_json.o allocations.o packet_setup.o
	gcc ${CFLAGS} -o $@ $^

client_cooperative : client_cooperative.c read_json.o allocations.o packet_setup.o
	gcc ${CFLAGS} -o $@ $^

server_cooperative : server_cooperative.c read_json.o allocations.o packet_setup.o
	gcc ${CFLAGS} -o $@ $^
